...
export const useNpmAudit = jest.fn(() => ({ mutate: jest.fn(), mutateAsync: jest.fn(), data: undefined, isPending: false }))
export const useNpmAuditQuick = jest.fn(() => ({ mutate: jest.fn(), mutateAsync: jest.fn(), data: undefined, isPending: false }))
export const useNpmMaintainer = jest.fn(() => defaultQuery)
export const useNpmMaintainerPackages = jest.fn(() => defaultQuery)
export const useNpmMaintainerAvatar = jest.fn(() => ({ ...defaultQuery, data: 'https://www.npmjs.com/npm-avatar/test' }))
...
export const npmQueryKeys = {
  ...
  packageCdnStats: (name: string, groupBy: string, period: string) => ['npm', 'package', name, 'cdn-stats', groupBy, period] as const,
  packageVersionSize: (name: string, version: string) => ['npm', 'package', name, 'version', version, 'size'] as const,
  packageVersionFiles: (name: string, version: string) => ['npm', 'package', name, 'version', version, 'files'] as const,
  packageVersionCdnStats: (name: string, version: string, groupBy: string, period: string) => ['npm', 'package', name, 'version', version, 'cdn-stats', groupBy, period] as const,
  packageVersionDependencies: (name: string, version: string) => ['npm', 'package', name, 'version', version, 'dependencies'] as const,
  bulkDownloads: (packages: string[], period: string) => ['npm', 'bulk-downloads', packages, period] as const,
