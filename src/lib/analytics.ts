...
export const Analytics = {
  addPackage: (name: string) => analytics && logEvent(analytics, 'add_package', { package_name: name }),
  addMaintainer: (username: string) => analytics && logEvent(analytics, 'add_maintainer', { username }),
